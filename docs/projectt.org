...
- represent apertium-uzb.uzb.lexc as a apertiumpp/dictionary and write
  a function for generating the former from the latter
...
- write abstract for turklang 2019
- start translating kaz, uzb, kaa into tat & checking the latter
