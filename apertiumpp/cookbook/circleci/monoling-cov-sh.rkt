...
@; Generate a .circleci/cov.sh for a monolingual Apertium package.
@; USAGE: racket monoling-cov-sh.rkt <ISO 639-3 language code>
@; EXAMPLE: racket monoling-cov-sh.rkt tat
...
aq-covtest /tmp/${CORPUS}.@|LANG|.txt @|LANG|.automorf.bin | tee /tmp/covtestlog
